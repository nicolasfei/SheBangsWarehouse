...
import com.shebangs.warehouse.ui.goodsback.BackActivity;
import com.shebangs.warehouse.ui.receipt.ReceiptActivity;
import com.shebangs.warehouse.ui.shipment.ShipmentActivity;
...
//        content.add(new ModuleNavigation(true, WarehouseApp.getInstance().getString(R.string.nav_warehouse_manager), 0, null));
        content.add(new ModuleNavigation(false, WarehouseApp.getInstance().getString(R.string.nav_warehousing), R.drawable.ic_warehousing, ReceiptActivity.class));
        content.add(new ModuleNavigation(false, WarehouseApp.getInstance().getString(R.string.nav_exwarehouse), R.drawable.ic_exwarehous, ShipmentActivity.class));
        content.add(new ModuleNavigation(false, WarehouseApp.getInstance().getString(R.string.nav_goodsback), R.drawable.ic_goods_back, BackActivity.class));
