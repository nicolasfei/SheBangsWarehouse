...
public class VersionCheckActivity extends AppCompatActivity {
            ...
            public void onChanged(OperateResult operateResult) {
                if (operateResult.getSuccess() != null) {
                    ...
                    if (msg.what == 1) {   //新版本发布
                        ...
                        viewModel.downNewVersionApp("http://updatestoreroom.scdawn.com/storeroom.apk");
                    } else {
                        dismissChecking();
                        jumpToLoginActivity();
                    }
    ...
    private void installApp(String apkPath) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            ...
            Uri uri = FileProvider.getUriForFile(this, WarehouseApp.getInstance().getPackageName() + ".fileProvider", apk);
